...
BOT_TOKEN = environ.get('BOT_TOKEN', '6554066079:AAGKQDsbW7VWC86tCCZ6LSKgf-AOBu4swRw')
...
# Bot images & videos
PICS = (environ.get('PICS', 'https://te.legra.ph/file/fe8abe13acbca84bace2d.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001787919806').split()]
