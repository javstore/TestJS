...
# Bot images & videos
PICS = (environ.get('PICS', 'https://te.legra.ph/file/0d5638082101230a89e3e.png')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1120085236').split()]
